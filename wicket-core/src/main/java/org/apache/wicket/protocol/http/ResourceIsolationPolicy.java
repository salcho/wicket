...
/**
 * Interface for the resource isolation policies to be used for
 * fetch metadata checks.
 *
 * Resource isolation policies are designed to protect against cross
 * origin attacks and use the {@code sec-fetch-*} request headers to decide
 * whether to accept or reject a request. Read more about
 * <a href="https://web.dev/fetch-metadata/">Fetch Metadata.</a>
 *
